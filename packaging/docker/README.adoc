...
all images in this repository are based on [Eclipse Timurin](https://projects.eclipse.org/projects/adoptium.temurin)
...
Examples: `eclipse-timurin-11-hotspot`, `eclipse-timurin-11-jre-alpine`

* `JVM_VENDOR` - source of the JVM in lowercase, e.g. Eclipse Timurin.
